...
int main()
{
    ...
    case 2:cout<<">>determinar si es par o impar<<"<<endl;
     float numero;
     div_t resultado;
    ...
    case 3:cout<<">>Convertir de kilometros a millas, metros a pulgadas, de libras a kilos y viceversa<<"<<endl;
     ...
     float input;
     char unidad;
     cout << "Ingrese un numero segurido de de la medida a convertir  (km para kilometros, mts para metros, lb para libras): ";
     cin >> input >> unidad;
     switch (unidad) {
        case 'km':  
            input *= 0.621371;
            cout << "la cantidad en millas es : " << input << " mi" << endl;
            break;
        case 'mts':  
            input *= 39.3701;
            cout << "la cantidad en pulgadas es : " << input << " in" << endl;
            break;
        case 'lb':  
            input *= 0.453592;
            cout << "la contidad en kilos es: " << input << " kg" << endl;
            break;
        default:
